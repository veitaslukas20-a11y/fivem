...
Config.WebHook = "https://discord.com/api/webhooks/976040092802101248/CBqTBGo7bJQfXYdL6kKT8NaGXfE8D7A1-VFsdBgS7U8759J61FZLPjg0acKqtNWt-I6e"--your webhook here
...
Config.TunningLocations = {
	{
		name = "Tiuningavimas", -- Name of the Location that will appear if blipmap == true
		coords = vector3(1807.8655, 3862.2039, 34.3675), --The coords to open menu
		...
		WebHook = "https://discord.com/api/webhooks/976040092802101248/CBqTBGo7bJQfXYdL6kKT8NaGXfE8D7A1-VFsdBgS7U8759J61FZLPjg0acKqtNWt-I6e"
	},
	{
		name = "Tiuningavimas", -- Name of the Location that will appear if blipmap == true
		coords = vector3(1821.8909, 3839.5718, 34.4339), --The coords to open menu
		job = "mechanic4", --The job that have access to it (remove the line and everyone can access it)
		howmuchtopay = 100, -- The percentage to pay. In this blip, the player/society will pay the normal price (100%), you can change it, for example, if you change it to 190, the player will pay 1.9x the original price, if the tunning costs 1000, the player will pay 1900
		society = false, -- The money that the client pay goes to the society account? (will only work if job isn't nil.)
		societypercentage = 50, --50% of the money goes to society and the other 50% goes to the mechanic (will only work if society = true.)
	...
	{
		name = "Tiuningavimas", -- Name of the Location that will appear if blipmap == true
		coords = vector3(1808.8766, 3840.5991, 35.4548), --The coords to open menu
		job = "mechanic4", --The job that have access to it (remove the line and everyone can access it)
		howmuchtopay = 100, -- The percentage to pay. In this blip, the player/society will pay the normal price (100%), you can change it, for example, if you change it to 190, the player will pay 1.9x the original price, if the tunning costs 1000, the player will pay 1900
		society = false, -- The money that the client pay goes to the society account? (will only work if job isn't nil.)
		societypercentage = 50, --50% of the money goes to society and the other 50% goes to the mechanic (will only work if society = true.)
	...
	{
		name = "Tiuningavimas", -- Name of the Location that will appear if blipmap == true
		coords = vector3(1806.0719, 3845.1499, 33.9236), --The coords to open menu
		job = "mechanic4", --The job that have access to it (remove the line and everyone can access it)
		howmuchtopay = 100, -- The percentage to pay. In this blip, the player/society will pay the normal price (100%), you can change it, for example, if you change it to 190, the player will pay 1.9x the original price, if the tunning costs 1000, the player will pay 1900
		society = false, -- The money that the client pay goes to the society account? (will only work if job isn't nil.)
		societypercentage = 50, --50% of the money goes to society and the other 50% goes to the mechanic (will only work if society = true.)
	...
	{
		name = "Tiuningavimas", -- Name of the Location that will appear if blipmap == true
		coords = vector3(1804.2523, 3850.4299, 34.4540), --The coords to open menu
		job = "mechanic4", --The job that have access to it (remove the line and everyone can access it)
		howmuchtopay = 100, -- The percentage to pay. In this blip, the player/society will pay the normal price (100%), you can change it, for example, if you change it to 190, the player will pay 1.9x the original price, if the tunning costs 1000, the player will pay 1900
		society = false, -- The money that the client pay goes to the society account? (will only work if job isn't nil.)
		societypercentage = 50, --50% of the money goes to society and the other 50% goes to the mechanic (will only work if society = true.)
	...
	{
		name = "Tiuningavimas", -- Name of the Location that will appear if blipmap == true
		coords = vector3(1929.9099, 3917.4045, 32.7322), --The coords to open menu
		job = "mechanic4", --The job that have access to it (remove the line and everyone can access it)
		howmuchtopay = 100, -- The percentage to pay. In this blip, the player/society will pay the normal price (100%), you can change it, for example, if you change it to 190, the player will pay 1.9x the original price, if the tunning costs 1000, the player will pay 1900
		society = false, -- The money that the client pay goes to the society account? (will only work if job isn't nil.)
		societypercentage = 50, --50% of the money goes to society and the other 50% goes to the mechanic (will only work if society = true.)
	...
	{
		name = "Tiuningavimas", -- Name of the Location that will appear if blipmap == true
		coords = vector3(1926.0240, 3913.2371, 32.8865), --The coords to open menu
		job = "mechanic4", --The job that have access to it (remove the line and everyone can access it)
		howmuchtopay = 100, -- The percentage to pay. In this blip, the player/society will pay the normal price (100%), you can change it, for example, if you change it to 190, the player will pay 1.9x the original price, if the tunning costs 1000, the player will pay 1900
		society = false, -- The money that the client pay goes to the society account? (will only work if job isn't nil.)
		societypercentage = 50, --50% of the money goes to society and the other 50% goes to the mechanic (will only work if society = true.)
	...
	{
		name = "Tiuningavimas", -- Name of the Location that will appear if blipmap == true
		coords = vector3(65.6729, 6576.9395, 31.6720), --The coords to open menu
	...
	{
		name = "Tiuningavimas", -- Name of the Location that will appear if blipmap == true
		coords = vector3(60.4604, 6572.9951, 31.6720), --The coords to open menu
		job = "mechanic3", --The job that have access to it (remove the line and everyone can access it)
		howmuchtopay = 100, -- The percentage to pay. In this blip, the player/society will pay the normal price (100%), you can change it, for example, if you change it to 190, the player will pay 1.9x the original price, if the tunning costs 1000, the player will pay 1900
		society = false, -- The money that the client pay goes to the society account? (will only work if job isn't nil.)
		societypercentage = 50, --50% of the money goes to society and the other 50% goes to the mechanic (will only work if society = true.)
	...
	{
		name = "Tiuningavimas", -- Name of the Location that will appear if blipmap == true
		coords = vector3(56.6133, 6568.1826, 31.6720), --The coords to open menu
		job = "mechanic3", --The job that have access to it (remove the line and everyone can access it)
		howmuchtopay = 100, -- The percentage to pay. In this blip, the player/society will pay the normal price (100%), you can change it, for example, if you change it to 190, the player will pay 1.9x the original price, if the tunning costs 1000, the player will pay 1900
		society = false, -- The money that the client pay goes to the society account? (will only work if job isn't nil.)
		societypercentage = 50, --50% of the money goes to society and the other 50% goes to the mechanic (will only work if society = true.)
	...
	{
		name = "Tiuningavimas", -- Name of the Location that will appear if blipmap == true
		coords = vector3(92.7475, 6563.6177, 31.5719), --The coords to open menu
		job = "mechanic3", --The job that have access to it (remove the line and everyone can access it)
		howmuchtopay = 100, -- The percentage to pay. In this blip, the player/society will pay the normal price (100%), you can change it, for example, if you change it to 190, the player will pay 1.9x the original price, if the tunning costs 1000, the player will pay 1900
		society = false, -- The money that the client pay goes to the society account? (will only work if job isn't nil.)
		societypercentage = 50, --50% of the money goes to society and the other 50% goes to the mechanic (will only work if society = true.)
	...
	{
		name = "Tiuningavimas", -- Name of the Location that will appear if blipmap == true
		coords = vector3(98.5790, 6557.9609, 31.5720), --The coords to open menu
		job = "mechanic3", --The job that have access to it (remove the line and everyone can access it)
		howmuchtopay = 100, -- The percentage to pay. In this blip, the player/society will pay the normal price (100%), you can change it, for example, if you change it to 190, the player will pay 1.9x the original price, if the tunning costs 1000, the player will pay 1900
		society = false, -- The money that the client pay goes to the society account? (will only work if job isn't nil.)
		societypercentage = 50, --50% of the money goes to society and the other 50% goes to the mechanic (will only work if society = true.)
	...
	{
		name = "Tiuningavimas", -- Name of the Location that will appear if blipmap == true
		coords = vector3(104.1912, 6552.4473, 31.6253), --The coords to open menu
		job = "mechanic3", --The job that have access to it (remove the line and everyone can access it)
		howmuchtopay = 100, -- The percentage to pay. In this blip, the player/society will pay the normal price (100%), you can change it, for example, if you change it to 190, the player will pay 1.9x the original price, if the tunning costs 1000, the player will pay 1900
		society = false, -- The money that the client pay goes to the society account? (will only work if job isn't nil.)
		societypercentage = 50, --50% of the money goes to society and the other 50% goes to the mechanic (will only work if society = true.)
	...
	{
		name = "Tiuningavimas", -- Name of the Location that will appear if blipmap == true
		coords = vector3(109.8312, 6546.7471, 31.6251), --The coords to open menu
		job = "mechanic3", --The job that have access to it (remove the line and everyone can access it)
		howmuchtopay = 100, -- The percentage to pay. In this blip, the player/society will pay the normal price (100%), you can change it, for example, if you change it to 190, the player will pay 1.9x the original price, if the tunning costs 1000, the player will pay 1900
		society = false, -- The money that the client pay goes to the society account? (will only work if job isn't nil.)
		societypercentage = 50, --50% of the money goes to society and the other 50% goes to the mechanic (will only work if society = true.)
	...
	{
		name = "Tiuningavimas", -- Name of the Location that will appear if blipmap == true
		coords = vector3(115.5217, 6541.1401, 31.6248), --The coords to open menu
		job = "mechanic3", --The job that have access to it (remove the line and everyone can access it)
		howmuchtopay = 100, -- The percentage to pay. In this blip, the player/society will pay the normal price (100%), you can change it, for example, if you change it to 190, the player will pay 1.9x the original price, if the tunning costs 1000, the player will pay 1900
		society = false, -- The money that the client pay goes to the society account? (will only work if job isn't nil.)
		societypercentage = 50, --50% of the money goes to society and the other 50% goes to the mechanic (will only work if society = true.)
	...
	{
		name = "Tiuningavimas", -- Name of the Location that will appear if blipmap == true
		coords = vector3(121.1293, 6535.4326, 31.6252), --The coords to open menu
		job = "mechanic3", --The job that have access to it (remove the line and everyone can access it)
		howmuchtopay = 100, -- The percentage to pay. In this blip, the player/society will pay the normal price (100%), you can change it, for example, if you change it to 190, the player will pay 1.9x the original price, if the tunning costs 1000, the player will pay 1900
		society = false, -- The money that the client pay goes to the society account? (will only work if job isn't nil.)
		societypercentage = 50, --50% of the money goes to society and the other 50% goes to the mechanic (will only work if society = true.)
	...
	{
		name = "Tiuningavimas", -- Name of the Location that will appear if blipmap == true
		coords = vector3(144.9658, -3030.6194, 7.0422), --The coords to open menu
	...
	{
		name = "Tiuningavimas", -- Name of the Location that will appear if blipmap == true
		coords = vector3(135.9981, -3031.1018, 7.0422), --The coords to open menu
		job = "mechanic2", --The job that have access to it (remove the line and everyone can access it)
		howmuchtopay = 100, -- The percentage to pay. In this blip, the player/society will pay the normal price (100%), you can change it, for example, if you change it to 190, the player will pay 1.9x the original price, if the tunning costs 1000, the player will pay 1900
		society = false, -- The money that the client pay goes to the society account? (will only work if job isn't nil.)
		societypercentage = 50, --50% of the money goes to society and the other 50% goes to the mechanic (will only work if society = true.)
	...
	{
		name = "Tiuningavimas", -- Name of the Location that will appear if blipmap == true
		coords = vector3(125.1826, -3035.0127, 7.0409), --The coords to open menu
		job = "mechanic2", --The job that have access to it (remove the line and everyone can access it)
		howmuchtopay = 100, -- The percentage to pay. In this blip, the player/society will pay the normal price (100%), you can change it, for example, if you change it to 190, the player will pay 1.9x the original price, if the tunning costs 1000, the player will pay 1900
		society = false, -- The money that the client pay goes to the society account? (will only work if job isn't nil.)
		societypercentage = 50, --50% of the money goes to society and the other 50% goes to the mechanic (will only work if society = true.)
	...
	{
		name = "Tiuningavimas", -- Name of the Location that will appear if blipmap == true
		coords = vector3(124.9521, -3047.4231, 7.0409), --The coords to open menu
		job = "mechanic2", --The job that have access to it (remove the line and everyone can access it)
		howmuchtopay = 100, -- The percentage to pay. In this blip, the player/society will pay the normal price (100%), you can change it, for example, if you change it to 190, the player will pay 1.9x the original price, if the tunning costs 1000, the player will pay 1900
		society = false, -- The money that the client pay goes to the society account? (will only work if job isn't nil.)
		societypercentage = 50, --50% of the money goes to society and the other 50% goes to the mechanic (will only work if society = true.)
	...
	{
		name = "Tiuningavimas", -- Name of the Location that will appear if blipmap == true
		coords = vector3(124.7090, -3041.2034, 7.0409), --The coords to open menu
		job = "mechanic2", --The job that have access to it (remove the line and everyone can access it)
		howmuchtopay = 100, -- The percentage to pay. In this blip, the player/society will pay the normal price (100%), you can change it, for example, if you change it to 190, the player will pay 1.9x the original price, if the tunning costs 1000, the player will pay 1900
		society = false, -- The money that the client pay goes to the society account? (will only work if job isn't nil.)
		societypercentage = 50, --50% of the money goes to society and the other 50% goes to the mechanic (will only work if society = true.)
	...
	{
		name = "Tiuningavimas", -- Name of the Location that will appear if blipmap == true
		coords = vector3(-212.7922, -1324.9913, 30.4778), --The coords to open menu
		job = "admin", --The job that have access to it (remove the line and everyone can access it)
		howmuchtopay = 100, -- The percentage to pay. In this blip, the player/society will pay the normal price (100%), you can change it, for example, if you change it to 190, the player will pay 1.9x the original price, if the tunning costs 1000, the player will pay 1900
		society = false, -- The money that the client pay goes to the society account? (will only work if job isn't nil.)
		societypercentage = 50, --50% of the money goes to society and the other 50% goes to the mechanic (will only work if society = true.)
		blipmap = false, --Show the blip in map?
	...
	{
		name = "Tiuningavimas", -- Name of the Location that will appear if blipmap == true
		coords = vector3(-1530.1477, 90.0156, 56.6701), --The coords to open menu
		job = "admin", --The job that have access to it (remove the line and everyone can access it)
		howmuchtopay = 100, -- The percentage to pay. In this blip, the player/society will pay the normal price (100%), you can change it, for example, if you change it to 190, the player will pay 1.9x the original price, if the tunning costs 1000, the player will pay 1900
		society = false, -- The money that the client pay goes to the society account? (will only work if job isn't nil.)
		societypercentage = 50, --50% of the money goes to society and the other 50% goes to the mechanic (will only work if society = true.)
	...
	{
		name = "Tiuningavimas", -- Name of the Location that will appear if blipmap == true
		coords = vector3(-932.2244, -2052.0601, 9.2510), --The coords to open menu
	...
	{
		name = "Tiuningavimas", -- Name of the Location that will appear if blipmap == true
		coords = vector3(-937.1597, -2057.0674, 9.2509), --The coords to open menu
		job = "mechanic", --The job that have access to it (remove the line and everyone can access it)
		howmuchtopay = 100, -- The percentage to pay. In this blip, the player/society will pay the normal price (100%), you can change it, for example, if you change it to 190, the player will pay 1.9x the original price, if the tunning costs 1000, the player will pay 1900
		society = false, -- The money that the client pay goes to the society account? (will only work if job isn't nil.)
		societypercentage = 50, --50% of the money goes to society and the other 50% goes to the mechanic (will only work if society = true.)
	...
	{
		name = "Tiuningavimas", -- Name of the Location that will appear if blipmap == true
		coords = vector3(-940.9124, -2010.7207, 9.5123), --The coords to open menu
		job = "mechanic", --The job that have access to it (remove the line and everyone can access it)
		howmuchtopay = 100, -- The percentage to pay. In this blip, the player/society will pay the normal price (100%), you can change it, for example, if you change it to 190, the player will pay 1.9x the original price, if the tunning costs 1000, the player will pay 1900
		society = false, -- The money that the client pay goes to the society account? (will only work if job isn't nil.)
		societypercentage = 50, --50% of the money goes to society and the other 50% goes to the mechanic (will only work if society = true.)
	...
	{
		name = "Tiuningavimas", -- Name of the Location that will appear if blipmap == true
		coords = vector3(-950.1703, -2033.0300, 9.2509), --The coords to open menu
		job = "mechanic", --The job that have access to it (remove the line and everyone can access it)
		howmuchtopay = 100, -- The percentage to pay. In this blip, the player/society will pay the normal price (100%), you can change it, for example, if you change it to 190, the player will pay 1.9x the original price, if the tunning costs 1000, the player will pay 1900
		society = false, -- The money that the client pay goes to the society account? (will only work if job isn't nil.)
		societypercentage = 50, --50% of the money goes to society and the other 50% goes to the mechanic (will only work if society = true.)
	...
	{
		name = "Tiuningavimas", -- Name of the Location that will appear if blipmap == true
		coords = vector3(-955.0530, -2027.8510, 9.2709), --The coords to open menu
		job = "mechanic", --The job that have access to it (remove the line and everyone can access it)
		howmuchtopay = 100, -- The percentage to pay. In this blip, the player/society will pay the normal price (100%), you can change it, for example, if you change it to 190, the player will pay 1.9x the original price, if the tunning costs 1000, the player will pay 1900
		society = false, -- The money that the client pay goes to the society account? (will only work if job isn't nil.)
		societypercentage = 50, --50% of the money goes to society and the other 50% goes to the mechanic (will only work if society = true.)
	...
	{
		name = "Tiuningavimas", -- Name of the Location that will appear if blipmap == true
		coords = vector3(-964.6870, -2036.6044, 9.2509), --The coords to open menu
		job = "mechanic", --The job that have access to it (remove the line and everyone can access it)
		howmuchtopay = 100, -- The percentage to pay. In this blip, the player/society will pay the normal price (100%), you can change it, for example, if you change it to 190, the player will pay 1.9x the original price, if the tunning costs 1000, the player will pay 1900
		society = false, -- The money that the client pay goes to the society account? (will only work if job isn't nil.)
		societypercentage = 50, --50% of the money goes to society and the other 50% goes to the mechanic (will only work if society = true.)
	...
	{
		name = "Tiuningavimas", -- Name of the Location that will appear if blipmap == true
		coords = vector3(-969.6932, -2041.6525, 9.2510), --The coords to open menu
		job = "mechanic", --The job that have access to it (remove the line and everyone can access it)
		howmuchtopay = 100, -- The percentage to pay. In this blip, the player/society will pay the normal price (100%), you can change it, for example, if you change it to 190, the player will pay 1.9x the original price, if the tunning costs 1000, the player will pay 1900
		society = false, -- The money that the client pay goes to the society account? (will only work if job isn't nil.)
		societypercentage = 50, --50% of the money goes to society and the other 50% goes to the mechanic (will only work if society = true.)
	...
	{
		name = "Tiuningavimas", -- Name of the Location that will appear if blipmap == true
		coords = vector3(-974.5922, -2046.5826, 9.2510), --The coords to open menu
		job = "mechanic", --The job that have access to it (remove the line and everyone can access it)
		howmuchtopay = 100, -- The percentage to pay. In this blip, the player/society will pay the normal price (100%), you can change it, for example, if you change it to 190, the player will pay 1.9x the original price, if the tunning costs 1000, the player will pay 1900
		society = false, -- The money that the client pay goes to the society account? (will only work if job isn't nil.)
		societypercentage = 50, --50% of the money goes to society and the other 50% goes to the mechanic (will only work if society = true.)
	...
	{
		name = "Tiuningavimas", -- Name of the Location that will appear if blipmap == true
		coords = vector3(-943.4952, -2062.7500, 9.2083), --The coords to open menu
		job = "mechanic", --The job that have access to it (remove the line and everyone can access it)
		howmuchtopay = 100, -- The percentage to pay. In this blip, the player/society will pay the normal price (100%), you can change it, for example, if you change it to 190, the player will pay 1.9x the original price, if the tunning costs 1000, the player will pay 1900
		society = false, -- The money that the client pay goes to the society account? (will only work if job isn't nil.)
		societypercentage = 50, --50% of the money goes to society and the other 50% goes to the mechanic (will only work if society = true.)
	...
	},
	{
		...
		coords = vector3(-940.7382, -2010.8324, 9.5123), --The coords to open menu
		job = "admin", --The job that have access to it (remove the line and everyone can access it)
