...
function appearance_switcher(type, number)
    if type == "sex" then
        ...
        TriggerEvent("skinchanger:loadSkin", {
            model = tempSkinTable['model']
        })
    elseif type == "ped" then
        tempSkinTable['model'] = Config.PedsList[number]
        TriggerEvent("skinchanger:loadSkin", {
            model = tempSkinTable['model']
        })
    elseif type == "mom" then
        if not IsPedModel(PlayerPedId(), 'mp_m_freemode_01') and not IsPedModel(PlayerPedId(), 'mp_f_freemode_01') then return end
    ...
    elseif type == "neck_thickness" then
        if not IsPedModel(PlayerPedId(), 'mp_m_freemode_01') and not IsPedModel(PlayerPedId(), 'mp_f_freemode_01') then return end
        tempSkinTable['faceFeatures'].neckThickness = ((tonumber(number) / 10) + 0.0)
    elseif type == "eyebrows_5" then
        if not IsPedModel(PlayerPedId(), 'mp_m_freemode_01') and not IsPedModel(PlayerPedId(), 'mp_f_freemode_01') then return end
        tempSkinTable['faceFeatures'].eyeBrownHigh = ((tonumber(number) / 10) + 0.0)
    elseif type == "eyebrows_6" then
        if not IsPedModel(PlayerPedId(), 'mp_m_freemode_01') and not IsPedModel(PlayerPedId(), 'mp_f_freemode_01') then return end
        tempSkinTable['faceFeatures'].eyeBrownForward = ((tonumber(number) / 10) + 0.0)
    elseif type == "nose_1" then
        if not IsPedModel(PlayerPedId(), 'mp_m_freemode_01') and not IsPedModel(PlayerPedId(), 'mp_f_freemode_01') then return end
        tempSkinTable['faceFeatures'].noseWidth = ((tonumber(number) / 10) + 0.0)
    elseif type == "nose_2" then
        if not IsPedModel(PlayerPedId(), 'mp_m_freemode_01') and not IsPedModel(PlayerPedId(), 'mp_f_freemode_01') then return end
        tempSkinTable['faceFeatures'].nosePeakHigh = ((tonumber(number) / 10) + 0.0)
    elseif type == "nose_3" then
        if not IsPedModel(PlayerPedId(), 'mp_m_freemode_01') and not IsPedModel(PlayerPedId(), 'mp_f_freemode_01') then return end
        tempSkinTable['faceFeatures'].nosePeakLowering = ((tonumber(number) / 10) + 0.0)
    elseif type == "nose_4" then
        if not IsPedModel(PlayerPedId(), 'mp_m_freemode_01') and not IsPedModel(PlayerPedId(), 'mp_f_freemode_01') then return end
        tempSkinTable['faceFeatures'].nosePeakSize = ((tonumber(number) / 10) + 0.0)
    elseif type == "nose_5" then
        if not IsPedModel(PlayerPedId(), 'mp_m_freemode_01') and not IsPedModel(PlayerPedId(), 'mp_f_freemode_01') then return end
        tempSkinTable['faceFeatures'].noseBoneHigh = ((tonumber(number) / 10) + 0.0)
    elseif type == "nose_6" then
        if not IsPedModel(PlayerPedId(), 'mp_m_freemode_01') and not IsPedModel(PlayerPedId(), 'mp_f_freemode_01') then return end
        tempSkinTable['faceFeatures'].noseBoneTwist = ((tonumber(number) / 10) + 0.0)
    elseif type == "cheeks_1" then
        if not IsPedModel(PlayerPedId(), 'mp_m_freemode_01') and not IsPedModel(PlayerPedId(), 'mp_f_freemode_01') then return end
        tempSkinTable['faceFeatures'].cheeksBoneHigh = ((tonumber(number) / 10) + 0.0)
    elseif type == "cheeks_2" then
        if not IsPedModel(PlayerPedId(), 'mp_m_freemode_01') and not IsPedModel(PlayerPedId(), 'mp_f_freemode_01') then return end
        tempSkinTable['faceFeatures'].cheeksBoneWidth = ((tonumber(number) / 10) + 0.0)
    elseif type == "cheeks_3" then
        if not IsPedModel(PlayerPedId(), 'mp_m_freemode_01') and not IsPedModel(PlayerPedId(), 'mp_f_freemode_01') then return end
        tempSkinTable['faceFeatures'].cheeksWidth = ((tonumber(number) / 10) + 0.0)
    elseif type == "lip_thickness" then
        if not IsPedModel(PlayerPedId(), 'mp_m_freemode_01') and not IsPedModel(PlayerPedId(), 'mp_f_freemode_01') then return end
        tempSkinTable['faceFeatures'].lipsThickness = ((tonumber(number) / 10) + 0.0)
    elseif type == "jaw_1" then
        if not IsPedModel(PlayerPedId(), 'mp_m_freemode_01') and not IsPedModel(PlayerPedId(), 'mp_f_freemode_01') then return end
        tempSkinTable['faceFeatures'].jawBoneWidth = ((tonumber(number) / 10) + 0.0)
    elseif type == "jaw_2" then
        if not IsPedModel(PlayerPedId(), 'mp_m_freemode_01') and not IsPedModel(PlayerPedId(), 'mp_f_freemode_01') then return end
        tempSkinTable['faceFeatures'].jawBoneBackSize = ((tonumber(number) / 10) + 0.0)
    elseif type == "chin_1" then
        if not IsPedModel(PlayerPedId(), 'mp_m_freemode_01') and not IsPedModel(PlayerPedId(), 'mp_f_freemode_01') then return end
        tempSkinTable['faceFeatures'].chinBoneLenght = ((tonumber(number) / 10) + 0.0)
    elseif type == "chin_2" then
        if not IsPedModel(PlayerPedId(), 'mp_m_freemode_01') and not IsPedModel(PlayerPedId(), 'mp_f_freemode_01') then return end
        tempSkinTable['faceFeatures'].chinBoneLowering = ((tonumber(number) / 10) + 0.0)
    elseif type == "chin_3" then
        if not IsPedModel(PlayerPedId(), 'mp_m_freemode_01') and not IsPedModel(PlayerPedId(), 'mp_f_freemode_01') then return end
        tempSkinTable['faceFeatures'].chinBoneSize = ((tonumber(number) / 10) + 0.0)
    elseif type == "chin_4" then
        if not IsPedModel(PlayerPedId(), 'mp_m_freemode_01') and not IsPedModel(PlayerPedId(), 'mp_f_freemode_01') then return end
        tempSkinTable['faceFeatures'].chinHole = ((tonumber(number) / 10) + 0.0)
    elseif type == "age_1" then
        if not IsPedModel(PlayerPedId(), 'mp_m_freemode_01') and not IsPedModel(PlayerPedId(), 'mp_f_freemode_01') then return end
        tempSkinTable['headOverlays'].ageing.style = tonumber(number)
    elseif type == "age_2" then
        if not IsPedModel(PlayerPedId(), 'mp_m_freemode_01') and not IsPedModel(PlayerPedId(), 'mp_f_freemode_01') then return end
        tempSkinTable['headOverlays'].ageing.opacity = ((tonumber(number) / 10) + 0.0)
    elseif type == "hair_1" then
        tempSkinTable['hair'].style = tonumber(number)
    elseif type == "hair_2" then
        tempSkinTable['hair'].texture = tonumber(number)
    elseif type == "hair_color_1" then
        tempSkinTable['hair'].color = tonumber(number)
    elseif type == "hair_color_2" then
        tempSkinTable['hair'].highlight = tonumber(number)
    elseif type == "beard_1" then
        tempSkinTable['headOverlays'].beard.style = tonumber(number)
    elseif type == "beard_2" then
        tempSkinTable['headOverlays'].beard.opacity = (tonumber(number) / 10) + 0.0
    elseif type == "beard_3" then
        tempSkinTable['headOverlays'].beard.color = tonumber(number)
    elseif type == "eyebrows_1" then
        tempSkinTable['headOverlays'].eyebrows.style = tonumber(number)
    elseif type == "eyebrows_2" then
        tempSkinTable['headOverlays'].eyebrows.opacity = (tonumber(number) / 10) + 0.0
    elseif type == "eyebrows_3" then
        tempSkinTable['headOverlays'].eyebrows.color = tonumber(number)
    elseif type == "makeup_1" then
        if not IsPedModel(PlayerPedId(), 'mp_m_freemode_01') and not IsPedModel(PlayerPedId(), 'mp_f_freemode_01') then return end
        tempSkinTable['headOverlays'].makeUp.style = tonumber(number)
    elseif type == "makeup_2" then
        if not IsPedModel(PlayerPedId(), 'mp_m_freemode_01') and not IsPedModel(PlayerPedId(), 'mp_f_freemode_01') then return end
        tempSkinTable['headOverlays'].makeUp.opacity = (tonumber(number) / 10) + 0.0
    elseif type == "makeup_3" then
        if not IsPedModel(PlayerPedId(), 'mp_m_freemode_01') and not IsPedModel(PlayerPedId(), 'mp_f_freemode_01') then return end
        tempSkinTable['headOverlays'].makeUp.color = tonumber(number)
    elseif type == "makeup_4" then
        if not IsPedModel(PlayerPedId(), 'mp_m_freemode_01') and not IsPedModel(PlayerPedId(), 'mp_f_freemode_01') then return end
        tempSkinTable['headOverlays'].makeUp.secondColor = tonumber(number)
    elseif type == "blush_1" then
        if not IsPedModel(PlayerPedId(), 'mp_m_freemode_01') and not IsPedModel(PlayerPedId(), 'mp_f_freemode_01') then return end
        tempSkinTable['headOverlays'].blush.style = tonumber(number)
    elseif type == "blush_2" then
        if not IsPedModel(PlayerPedId(), 'mp_m_freemode_01') and not IsPedModel(PlayerPedId(), 'mp_f_freemode_01') then return end
        tempSkinTable['headOverlays'].blush.opacity = (tonumber(number) / 10) + 0.0
    elseif type == "blush_3" then
        if not IsPedModel(PlayerPedId(), 'mp_m_freemode_01') and not IsPedModel(PlayerPedId(), 'mp_f_freemode_01') then return end
        tempSkinTable['headOverlays'].blush.color = tonumber(number)
    elseif type == "lipstick_1" then
        if not IsPedModel(PlayerPedId(), 'mp_m_freemode_01') and not IsPedModel(PlayerPedId(), 'mp_f_freemode_01') then return end
        tempSkinTable['headOverlays'].lipstick.style = tonumber(number)
    elseif type == "lipstick_2" then
        if not IsPedModel(PlayerPedId(), 'mp_m_freemode_01') and not IsPedModel(PlayerPedId(), 'mp_f_freemode_01') then return end
        tempSkinTable['headOverlays'].lipstick.opacity = (tonumber(number) / 10) + 0.0
    elseif type == "lipstick_3" then
        if not IsPedModel(PlayerPedId(), 'mp_m_freemode_01') and not IsPedModel(PlayerPedId(), 'mp_f_freemode_01') then return end
        tempSkinTable['headOverlays'].lipstick.color = tonumber(number)
    elseif type == "chest_1" then
        if not IsPedModel(PlayerPedId(), 'mp_m_freemode_01') and not IsPedModel(PlayerPedId(), 'mp_f_freemode_01') then return end
        tempSkinTable['headOverlays'].chestHair.style = tonumber(number)
    elseif type == "chest_2" then
        if not IsPedModel(PlayerPedId(), 'mp_m_freemode_01') and not IsPedModel(PlayerPedId(), 'mp_f_freemode_01') then return end
        tempSkinTable['headOverlays'].chestHair.opacity = (tonumber(number) / 10) + 0.0
    elseif type == "chest_3" then
        if not IsPedModel(PlayerPedId(), 'mp_m_freemode_01') and not IsPedModel(PlayerPedId(), 'mp_f_freemode_01') then return end
        tempSkinTable['headOverlays'].chestHair.color = tonumber(number)
    elseif type == "blemishes_1" then
        if not IsPedModel(PlayerPedId(), 'mp_m_freemode_01') and not IsPedModel(PlayerPedId(), 'mp_f_freemode_01') then return end
        tempSkinTable['headOverlays'].blemishes.style = tonumber(number)
    elseif type == "blemishes_2" then
        if not IsPedModel(PlayerPedId(), 'mp_m_freemode_01') and not IsPedModel(PlayerPedId(), 'mp_f_freemode_01') then return end
        tempSkinTable['headOverlays'].blemishes.opacity = tonumber(number)
    elseif type == "complexion_1" then
        if not IsPedModel(PlayerPedId(), 'mp_m_freemode_01') and not IsPedModel(PlayerPedId(), 'mp_f_freemode_01') then return end
        tempSkinTable['headOverlays'].complexion.style = tonumber(number)
    elseif type == "complexion_2" then
        if not IsPedModel(PlayerPedId(), 'mp_m_freemode_01') and not IsPedModel(PlayerPedId(), 'mp_f_freemode_01') then return end
        tempSkinTable['headOverlays'].complexion.opacity = tonumber(number)
    elseif type == "sun_1" then
        if not IsPedModel(PlayerPedId(), 'mp_m_freemode_01') and not IsPedModel(PlayerPedId(), 'mp_f_freemode_01') then return end
        tempSkinTable['headOverlays'].sunDamage.style = tonumber(number)
    elseif type == "sun_2" then
        if not IsPedModel(PlayerPedId(), 'mp_m_freemode_01') and not IsPedModel(PlayerPedId(), 'mp_f_freemode_01') then return end
        tempSkinTable['headOverlays'].sunDamage.opacity = tonumber(number)
    elseif type == "moles_1" then
        if not IsPedModel(PlayerPedId(), 'mp_m_freemode_01') and not IsPedModel(PlayerPedId(), 'mp_f_freemode_01') then return end
        tempSkinTable['headOverlays'].moleAndFreckles.style = tonumber(number)
    elseif type == "moles_2" then
        if not IsPedModel(PlayerPedId(), 'mp_m_freemode_01') and not IsPedModel(PlayerPedId(), 'mp_f_freemode_01') then return end
        tempSkinTable['headOverlays'].moleAndFreckles.opacity = tonumber(number)
    elseif type == "eye_squint" then
        if not IsPedModel(PlayerPedId(), 'mp_m_freemode_01') and not IsPedModel(PlayerPedId(), 'mp_f_freemode_01') then return end
        tempSkinTable['faceFeatures'].eyesOpening = (tonumber(number) / 10) + 0.0
...
function updateValue()
    ...
    if IsPedModel(PlayerPedId(), 'mp_m_freemode_01') or IsPedModel(PlayerPedId(), 'mp_f_freemode_01') then
        ...
        SetPedHeadOverlayColor(myPed, 2, 1, tempSkinTable['headOverlays'].eyebrows.color, tempSkinTable['headOverlays'].eyebrows.secondColor)
        
        SetPedHeadOverlay(myPed, 1, tempSkinTable['headOverlays'].beard.style, tempSkinTable['headOverlays'].beard.opacity + 0.0)
        SetPedHeadOverlayColor(myPed, 1, 1, tempSkinTable['headOverlays'].beard.color, tempSkinTable['headOverlays'].beard.secondColor)
        
        SetPedHeadOverlay(myPed, 5, tempSkinTable['headOverlays'].blush.style, tempSkinTable['headOverlays'].blush.opacity + 0.0)
        SetPedHeadOverlayColor(myPed, 5, 2, tempSkinTable['headOverlays'].blush.color, tempSkinTable['headOverlays'].blush.secondColor)
        
        SetPedHeadOverlay(myPed, 8, tempSkinTable['headOverlays'].lipstick.style, tempSkinTable['headOverlays'].lipstick.opacity + 0.0)
        SetPedHeadOverlayColor(myPed, 8, 2, tempSkinTable['headOverlays'].lipstick.color, tempSkinTable['headOverlays'].lipstick.secondColor)
        
        SetPedHeadOverlay(myPed, 4, tempSkinTable['headOverlays'].makeUp.style, tempSkinTable['headOverlays'].makeUp.opacity + 0.0)
        SetPedHeadOverlayColor(myPed, 4, 2, tempSkinTable['headOverlays'].makeUp.color, tempSkinTable['headOverlays'].makeUp.secondColor)
        
        SetPedHeadOverlay(myPed, 3, tempSkinTable['headOverlays'].ageing.style, tempSkinTable['headOverlays'].ageing.opacity + 0.0)
        
        SetPedHeadOverlay(myPed, 10, tempSkinTable['headOverlays'].chestHair.style, tempSkinTable['headOverlays'].chestHair.opacity)
        SetPedHeadOverlayColor(myPed, 10, 1, tempSkinTable['headOverlays'].chestHair.color, tempSkinTable['headOverlays'].chestHair.secondColor)
    ...
    SetPedComponentVariation(myPed, 2, tempSkinTable['hair'].style, tempSkinTable['hair'].texture, 0)
    SetPedHairColor(myPed, tempSkinTable['hair'].color, tempSkinTable['hair'].highlight)
