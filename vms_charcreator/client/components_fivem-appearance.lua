...
function updateValue()
    ...
    for i = 1, #tempSkinTable.components, 1 do
        if tempSkinTable.components[i].component_id ~= 2 then
            SetPedComponentVariation(myPed, tempSkinTable.components[i].component_id,
                tempSkinTable.components[i].drawable, 0, 2)
            SetPedComponentVariation(myPed, tempSkinTable.components[i].component_id,
                tempSkinTable.components[i].drawable, tempSkinTable.components[i].texture, 0)
        end
    end
    ...
    for i = 1, #tempSkinTable.props, 1 do
        if tempSkinTable.props[i].drawable ~= -1 then
            ...
            SetPedPropIndex(myPed, tempSkinTable.props[i].prop_id, tempSkinTable.props[i].drawable,
                tempSkinTable.props[i].texture, true)
        else
