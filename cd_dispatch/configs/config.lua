...
Config.AntiCheat = {
    ...
    BannedWords = { -- This will detect any banned words in a dispatch alert or /911 call.
        ENABLE = true, -- Enable or Disable this feature?
        banned_words = {'http','discord','.gg','fuck','fucker','fucking','shit','shitty','bullshit','cunt','bitch','bastard','asshole','arsehole','motherfucker','whore','slut','hoe','skank','retard','prick','twat','wanker','dipshit','shithead','fuckhead','asshat','fuk','fck','fuq','sh1t','b1tch','c*nt','f*ck','biatch','azzhole','a$$hole' } --A table of banned words.
    },
