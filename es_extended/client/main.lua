-- es_extended/client/main.lua - COMPLETELY FIXED VERSION
-- Fixed: Removed problematic deivuks-utils exports, added proper error handling
...
AddEventHandler('esx:playerLoaded', function(xPlayer, isNew, skin)
    ...
    -- FIXED: Health handling - removed problematic deivuks-utils export
    if metadata.health then
		if metadata.health > 199 then metadata.health = 199 end
        SetEntityHealth(ESX.PlayerData.ped, metadata.health)
    end

    -- FIXED: Armor handling - removed problematic deivuks-utils export
    if metadata.armor and metadata.armor > 0 then
		if metadata.armor > 99 then metadata.armor = 0 end
...
print("^2[es_extended] Client main.lua loaded successfully^7")