Locales["en"] = {
  ...
  -- Salary related
  ['received_salary'] = 'Jums buvo sumokėta: $%s',
  ['received_help'] = 'Jums buvo išmokėta pašalpa: $%s',
  ['company_nomoney'] = 'įmonė, kurioje dirbate,neturi pinigų, kad išmokėtų jums atlyginimą',
  ['received_paycheck'] = 'gavote atlyginimą',
  ['bank'] = 'Maze Bankas',
  ['account_bank'] = 'Bankas',
  ['account_black_money'] = 'Nešvarūs pinigai',
  ['account_money'] = 'Grynieji pinigai',

  ['act_imp'] = 'Negalima atlikti veiksmo',
  ['in_vehicle'] = 'Neįmanoma atlikti veiksmo, žaidėjas yra transporto priemonėje',
  ["not_in_vehicle"] = "Neėmanoma atlikti veiksmo nesant automobilyje.",
